(function(){
	...
	function renderJiraGerritChanges() {
		var webLinks = jQuery('[data-testid="issue.views.issue-base.content.web-links.top-container.scope-generic"]').parent();
		var gerritLinks = webLinks.clone();
		gerritLinks.html(getChangeListPopupContent());
		gerritLinks.attr('id', 'gerrit-links');
		webLinks.after(gerritLinks);
	}
